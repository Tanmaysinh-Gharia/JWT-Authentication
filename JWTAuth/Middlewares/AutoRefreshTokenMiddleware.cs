...
using JWTAuth.Core.Common;
using Microsoft.IdentityModel.Tokens;
using System.IdentityModel.Tokens.Jwt;
using System.Text;

namespace JWTAuth.API.Middlewares
{
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(authHeader))
            {
                ...
                catch (SecurityTokenExpiredException)
                {
                    ...
                    var refreshResponse = await client.PostAsJsonAsync("https://localhost:7201/api/auth/refresh", refreshToken);
                    ...
                    var tokenResponse = await refreshResponse.Content.ReadFromJsonAsync<AuthResponse>();
